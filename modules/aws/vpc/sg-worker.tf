...
resource "aws_security_group_rule" "worker_ingress_weave_udp" {
...
resource "aws_security_group_rule" "worker_ingress_weave_tcp" {
  count = "${ var.tectonic_container_overlay_network == "weave" ? 1 : 0 }"
...
resource "aws_security_group_rule" "worker_ingress_weave_from_master_udp" {
  count = "${ var.tectonic_container_overlay_network == "weave" ? 1 : 0 }"
...
resource "aws_security_group_rule" "worker_ingress_weave_from_master_tcp" {
  count = "${ var.tectonic_container_overlay_network == "weave" ? 1 : 0 }"
